...
$table1.='<tr>
            <td style="text-align: center; font-size: 16px; font-weight:bold;">LAPORAN PEMINJAMAN BARANG
            </td>
        </tr>';
$table1.= '</table> </br>';
...
$table2.='<tr style="background-color:lightblue">
            <td height="30" style="text-align:center; font-weight:bold;">Id Pinjam</td>
         ...
         foreach ($data as $row) {
$table2.='<tr>
            <td height="30" style="text-align:center;">' .$row->id_pinjam. '</td>
